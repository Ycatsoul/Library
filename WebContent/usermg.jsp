...
<script type="text/javascript" language="javascript">
	alert("添加成功");                                            
	window.location="Admintor.do?type=fineuser";                            //
</script> 
<%
...
window.location.href = "Admintor.do?type=deluser&delid="+url;

}

document.form1.action("Admintor.do?type=deluser&delid="+url);
...
<body>
 	...
 	<div role="tabpanel" class="tab-pane" id="char">
                        ...
                        <div class="check-div">
                            <button class="btn btn-yellow btn-xs" style="margin-top: 10px" data-toggle="modal" data-target="#addChar">添加用户</button>
                        ...
                        <div class="data-div">
                            ...
                            <div class="col-xs-2">  
								...
								<%-- <a class="btn btn-danger btn-xs" href="Admintor.do?type=deluser&delid=${list.getUserid()}">删除</a> --%>
                            </div>
                        	</div>
                        </c:forEach>
                    </div>
