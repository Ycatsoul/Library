    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                <div id="logoDiv">
                    <p id="logoP"><img id="logo" alt="左右结构项目" src="images/logo.png"><span>图书管理系统</span></p>
                </div>
                <div id="personInfor">
                ...
                <div class="meun-item" href="#char" aria-controls="char" role="tab" data-toggle="tab"><a href="index.jsp">权限管理</a></div> 
